...
function duringDrag(e) {
    ...
    // Se a distância total percorrida for maior que 5 pixels, considera que houve arraste
    ...
    // Se você estiver usando background-position ou transform, use a propriedade correta
    
    // Neste caso, vamos usar a propriedade 'left' e 'top' e ajustá-las via CSS
    ...
    // Usamos um único 'transform' para evitar conflito com 'scale'
