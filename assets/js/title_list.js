...
function renderizarCards(titulos, containerId, appendResults = false) {
    ...
    titulos.forEach(titulo => {
        ...
        cardWrapper.innerHTML = `<div class="holder-card-title">
            <div class="book">
                <div class="lib_cardInfo">
                    ...
                    <p class="lib_cardO" title="${titulo.original}">
                        ${titulo.original}
                    </p>
            ...
            <ul class="example-2">
                ...
                <li class="icon-content">
                  <a data-social="edit" aria-label="Editar" href="javascript:void(0)">
                  ...
                  <li class="icon-content">
                  <a data-social="delete" aria-label="Deletar" href="javascript:void(0)">
